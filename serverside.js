...
(function() {
  var Backbone, async, comm, crypto, decorate, decorators, dgram, ejslocals, env, express, helpers, http, initCollections, initDb, initExpress, initListener, initLogger, initRoutes, initWebsockets, logger, mongodb, settings, _;
  ...
  initListener = function(env, callback) {
    ...
    server.on("message", function(msg, rinfo) {
      return env.websocket.msg(new comm.Msg(JSON.parse(msg)));
    });
  ...
  initCollections = function(env, callback) {
    /*
